...
#include "../DebugConfig.h"
	...
	#define CONFIG_L2_RECEIVE_BUFFER_LEN 2
	...
	#define CONFIG_L3_RECEIVE_BUFFER_LEN 3
	#define CONFIG_L3_SEND_BUFFER_LEN 3
	#define CONFIG_L3_NUMBERED_RETRANSMISSIONS 2
	#define CONFIG_L3_NUMBERED_TIMEOUT_MS (5000)
