/**
// see http://playground.arduino.cc/Main/MPU-6050
...
#if !defined(_INVENSENSEMPU6050_H)
#define _INVENSENSEMPU6050_H
...
class InvenSenseMPU6050 : public I2C, public Temperature, public Accelerometer, public Gyroscope {
	Triple<int16_t> gyroTriple;
	Triple<int16_t> accelTriple;
	float temperature;
